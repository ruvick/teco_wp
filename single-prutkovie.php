    ...
    <section id="product-sec" class="product-sec recurring">  
      <div class="_container">
				...
				<div class="pr-card__row">
					<? 
						$prCard = carbon_get_post_meta(get_the_ID(),"prut_complex"); 
					...
					?>
						<a href="<?echo get_the_permalink(get_the_ID());?>" class="pr-card__item">
							<div class="pr-card__img">
								<img src="<?php echo wp_get_attachment_image_src($item['prut_complex_img'], 'large')[0]; ?>" alt="">
							</div>
							<div class="pr-card__descp">
								<h4 class="pr-card__descp-title"><? echo $item['prut_complex_title']; ?></h4>
								<p class="pr-card__descp-text"><strong>Рабочая температура: </strong><? echo $item['prut_complex_descp']; ?></p>
							</div>
						</a>
					<?
							$prCardIndex++; 
