    ...
    <div class="header__row d-flex">
      ...
      <div class="header__navigation">
        ...
        <? $tel = carbon_get_theme_option("as_phones_1"); 
          ...
          <p class="contacts__time-phone header__time-phone"><a href="mailto:<?echo carbon_get_theme_option("as_email");?>"><?echo carbon_get_theme_option("as_email");?></a></p>
        </div>
        ...
        <a href="<?php echo carbon_get_theme_option('as_whatsapp'); ?>" class="header__soc-block-icon-link soc-block-icon-link soc-icon-whatsapp"></a>
